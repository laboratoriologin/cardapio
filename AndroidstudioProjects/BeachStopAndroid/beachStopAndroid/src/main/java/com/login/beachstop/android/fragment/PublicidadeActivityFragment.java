...
import com.login.beachstop.android.util.ImageLoader;
...
public final class PublicidadeActivityFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (this.publicidade.getImagem().length() != 0) {
			...
			if (img == null) {
				new ImageLoader(this.imageViewMidia, this.view.getContext()).execute(Constantes.URL_IMG + this.publicidade.getImagem());
			} else {
