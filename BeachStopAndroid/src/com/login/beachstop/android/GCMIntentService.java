...
import com.login.beachstop.android.business.TokenBS;
import com.login.beachstop.android.util.Constantes;
import com.login.beachstop.android.util.Notificacao;
...
public class GCMIntentService extends GCMBaseIntentService {
	...
	/**
	 * Método executado quando o aplicativo se registra no GCM para o
	...
	protected void onRegistered(Context context, String regId) {
		 ...
		 * posteriormente, no aplicativo cliente, para o envio de mensagens da
		 * Nuvem para o dispositivo Android.
		 */
	...
	/**
	 * Método executado quando algum erro ocorre na comunicação com o GCM.
	 */
	@Override
	...
	/**
	 * Método executado quando uma nova mensagem é recebida da Nuvem através do
	 * GCM.
	 */
	@Override
	protected void onMessage(Context context, Intent intent) {
		/*
		 * Recuperamos a mensagem recebida através do Extras da Intent do GCM
		 * que invocou este Service.
		 */
		String mensagem = intent.getExtras().getString("mensagem");
		Log.i(Constantes.TAG, "Mensagem recebida: " + mensagem);

		/*
		 * Disparamos uma Notificação para avisar o usuário sobre a nova
		 * mensagem recebida da Nuvem.
		 */
		if (mensagem != null && !"".equals(mensagem))
			Notificacao.mostraNotificacao("Beach Stop Ipitanga", mensagem, context);
