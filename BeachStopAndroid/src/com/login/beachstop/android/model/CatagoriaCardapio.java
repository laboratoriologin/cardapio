...
public class CatagoriaCardapio implements Serializable {
	...
	private void loadItemMenu() {
		...
		this.listaItemMenu.put(8, new CategoriaCardapioItemSys(9l, "Comida oriental", R.drawable.bt_home_comida_oriental, R.drawable.icone_topo_comida_oriental, ListaItemCardapioFragment.class));
		this.listaItemMenu.put(8, new CategoriaCardapioItemSys(10l, "Diversos", R.drawable.bt_home_diversos, R.drawable.icone_topo_diversos, ListaItemCardapioFragment.class));
		this.listaItemMenu.put(8, new CategoriaCardapioItemSys(11l, "Massas", R.drawable.bt_home_massas, R.drawable.icone_topo_massas, ListaItemCardapioFragment.class));
		this.listaItemMenu.put(8, new CategoriaCardapioItemSys(13l, "Sugestão do chef", R.drawable.bt_home_sugestao_chef, R.drawable.icone_topo_sugestao_chef, ListaItemCardapioFragment.class));
