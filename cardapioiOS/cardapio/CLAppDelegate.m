...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[UITabBar appearance]setBarTintColor:[UIColor colorFromHexString:@"#634C47"]];
...
- (void)configureSplash {
    ...
    self.configAppLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, self.window.center.y + 120, 320, 50)];
    
    [self.configAppLabel setTextColor:[UIColor whiteColor]];
    
    [self.configAppLabel setTextAlignment:NSTextAlignmentCenter];
    
    [self.configAppLabel setFont:[UIFont appFontWithSize:15]];
    ...
    self.indicador.center = CGPointMake(self.window.center.x,self.window.center.y + 110);
