...
extern NSString* const CLAppBaseUrl;
extern NSString* const CLKeyEmpresa;
extern NSString* const CLUrlImagem;
extern NSString* const CLUrlHtml;
...
extern NSString* const CLNomeEmpresa;
@end
