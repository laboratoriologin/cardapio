...
//  cardapio
//
//  Created by Julio Rocha on 16/06/14.
...
NSString* const CLAppBaseUrl = @"http://10.0.0.109:8080/CardapioWS/";
NSString* const CLTipoAlertaChamarGarcom = @"1";
NSString* const CLTipoAlertaPedirConta = @"2";
NSString* const CLKeyEmpresa = @"123";
NSString* const CLUrlHtml = @"http://10.0.0.109:8080/CardapioWS/empresas/keymobile/%@/dadosEmpresa";
NSString* const CLUrlImagem = @"http://10.0.0.109:8080/arquivos_cardapio/%@";
...
NSString* const CLNomeEmpresa = @"Beach Stop Ipitanga";
@end
