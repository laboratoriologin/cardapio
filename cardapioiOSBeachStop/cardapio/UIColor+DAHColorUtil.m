...
+ (UIColor *)appButtonColor {
    ...
    return [UIColor colorFromHexString:@"#2175B1"];
    
}

+ (UIColor *)appButtonTextColor {
    
    return [UIColor colorFromHexString:@"#0B405F"];
    
}

+ (UIColor *)appBackgroundColor {
    
    return [UIColor colorFromHexString:@"#F3F3AD"];
    
}

+ (UIColor *)appHeaderTableViewColor {
    
    return [UIColor colorFromHexString:@"#414142"];
